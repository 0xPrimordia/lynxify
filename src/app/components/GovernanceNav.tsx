...
export default function GovernanceNav({ currentSection }: GovernanceNavProps) {
  const navItems = [
    {
      name: 'Dashboard',
      href: '/wallet/governance',
      icon: HomeIcon,
      id: 'dashboard'
    },
    {
      name: 'Composition',
      href: '/wallet/governance/composition',
      icon: ChartPieIcon,
      id: 'composition'
    },
    {
      name: 'Rebalancing',
      href: '/wallet/governance/rebalancing',
      icon: ArrowPathIcon,
      id: 'rebalancing'
    },
    {
      name: 'Proposals',
      href: '/wallet/governance/proposals',
